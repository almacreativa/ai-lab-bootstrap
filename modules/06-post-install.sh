...
echo ""
echo "     # Acceder a la GUI (via Tailscale, no expongas al internet público):"
echo "     http://\$(tailscale ip --4):8384"
echo ""
echo "     # En GUI → Actions → Settings → GUI:"
echo "     GUI Listen Address: \$(tailscale ip --4):8384"
echo "     Configurar usuario y contraseña"
echo ""
echo "     # En GUI → Settings → Connections:"
echo "     Listen Addresses: tcp://\$(tailscale ip --4):22000"
