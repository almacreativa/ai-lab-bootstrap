...
echo ""
echo "  5. Pasos manuales:"
echo "     a. Copiar .env files a sus ubicaciones"
echo "     b. Restaurar APT sources + keyrings ANTES de instalar paquetes"
echo "     c. Crear Docker networks ANTES de levantar stacks"
echo "     d. Restaurar dumps PostgreSQL con psql (no pg_restore)"
echo "     e. Correr core-guard.sh para verificar estado"
echo ""
